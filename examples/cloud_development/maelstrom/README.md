...
[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/https://github.com/synopkg/devbox-examples?folder=cloud_development/maelstrom)
...
If you don't already have [Devbox](https://synopkg.github.io/devbox/docs/installing_devbox/), you can install it by running the following command:
