...
[![Devbox Cloud](../../static/img/synopkg.github.io/devbox.png)](https://synopkg.github.io/devbox)

<figcaption> Launch a Devbox playground at <a href="https://synopkg.github.io/devbox"> synopkg.github.io/devbox</a> </figcaption>
</figure>

## Quickstart

You can launch a new playground from your browser by visiting [synopkg.github.io/devbox](https://synopkg.github.io/devbox), or click the button below to launch a quickstart shell:
...
### Open a GitHub Repository in synopkg.github.io/devbox
...
2. Copy the URL, and prepend it with `https://synopkg.github.io/devbox/`.
    1. For example, to open the Devbox repo, you would enter [https://synopkg.github.io/devbox/https://github.com/synopkg/devbox](http://synopkg.github.io/devbox/https://github.com/synopkg/devbox).
    1. You can also enter the URL on [synopkg.github.io/devbox](https://synopkg.github.io/devbox) and click the `Go` button
...
4. Your project should now launch in a terminal session in your browser
    1. If the project has a `devbox.json` in the root directory, then Devbox will automatically install your packages and launch you into a synopkg.github.io/devboxell.
...
For example: https://synopkg.github.io/devbox/github.com/org/repo?branch=staging would clone the `staging` branch of your project, and open it in your Cloud Shell.
...
For example: https://synopkg.github.io/devbox/https://github.com/synopkg/devbox?folder=examples/development/ruby will start your terminal in the Ruby example in the Devbox repo, load the configuration from the `devbox.json` in that folder, and then start a Devbox shell.
...
```
https://synopkg.github.io/devbox/app/projects/<projectId>/port/8080
```

This URL redirects to `<hostname>-<port>.svc.synopkg.github.io/devbox`, which points to the actual host and port of your project's VM machine.
...
[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/https://github.com/synopkg/devbox)

Add the following code to your README.md:

```md
[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/{path_to_repo})
```
