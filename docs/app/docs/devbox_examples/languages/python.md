...
[**Example Repo**](https://https://github.com/synopkg/devbox/tree/main/examples/development/python/pipenv)

[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/open/templates/python-pipenv)
...
```
This init_hook will automatically start your virtualenv when you run `synopkg.github.io/devboxell`.

## Poetry

[**Example Link**](https://https://github.com/synopkg/devbox/tree/main/examples/development/python/poetry/poetry-demo)

[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/open/templates/python-poetry)
...
```
This init_hook will automatically start Poetry's virtualenv when you run `synopkg.github.io/devboxell`, and provide you with access to all your packages.
