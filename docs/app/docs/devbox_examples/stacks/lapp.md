...
[Example Repo](https://https://github.com/synopkg/devbox/tree/main/examples/stacks/lapp-stack)
...
2. Once the services are running, you can start your shell using `synopkg.github.io/devboxell`. This will also initialize your database by running `initdb` in the init hook.
