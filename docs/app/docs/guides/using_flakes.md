...
- [Using Nix Flakes from Github](https://https://github.com/synopkg/devbox/tree/main/examples/flakes/remote)
- [Using a Local Flake](https://https://github.com/synopkg/devbox/tree/main/examples/flakes/php)
- [Applying an Overlay with Nix Flakes](https://https://github.com/synopkg/devbox/tree/main/examples/flakes/overlay)
