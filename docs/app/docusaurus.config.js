...
const config = {
    ...
    organizationName: 'synopkg', // Usually your GitHub org/user name.
        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl: "https://https://github.com/synopkg/devbox/tree/main/docs/app/"
                },
                blog: false,
                theme: {
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ...
        navbar: {
            ...
            items: [{
                ...
                {
                    href: 'https://https://github.com/synopkg/devbox',
                    // label: 'GitHub',
        ...
        footer: {
            links: [{
                ...
                },
                {
                    ...
                    items: [{
                            label: "Home",
                            to: "https://synopkg.github.io/devbox"
                        },
                        {
                            label: "Docs",
                            to: "https://synopkg.github.io/devbox/docs/"
                        }
                    ]
                },

                {
                    ...
                    items: [
                        ...
                        {
                            label: "Github",
                            href: "https://https://github.com/synopkg"
                        },
                        {
                            label: "Twitter",
