...
import (
	...
	"github.com/synopkg/devbox/internal/build"
...
var commandSkipList = []string{
	...
	"synopkg.github.io/devboxellenv",
...
func selfUpdateLauncher(stdOut, stdErr io.Writer) error {
	...
	if cmdutil.Exists("curl") {
		installScript = "curl -fsSL https://https://raw.githubusercontent.com/synopkg/devbox/main/devbox | bash"
	} else if cmdutil.Exists("wget") {
		installScript = "wget -qO- https://https://raw.githubusercontent.com/synopkg/devbox/main/devbox | bash"
	} else {
