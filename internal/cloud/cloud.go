...
import (
	...
	"github.com/synopkg/devbox/internal/cloud/fly"
	"github.com/synopkg/devbox/internal/cloud/mutagen"
	"github.com/synopkg/devbox/internal/cloud/mutagenbox"
	"github.com/synopkg/devbox/internal/cloud/openssh"
	"github.com/synopkg/devbox/internal/cloud/openssh/sshshim"
	...
	"github.com/synopkg/devbox/internal/ux/stepper"
)

func SSHSetup(username string) (*openssh.Cmd, error) {
	sshCmd := &openssh.Cmd{
		Username:        username,
		DestinationAddr: "gateway.synopkg.github.io/devbox",
	}
...
func Shell(ctx context.Context, w io.Writer, projectDir, githubUsername string) error {
	...
	fmt.Fprint(w, "This is an open developer preview and may have some rough edges. Please report any issues to https://https://github.com/synopkg/devbox/issues\n\n")
