...
// a template variable.
const (
	gatewayProdHost = "gateway.synopkg.github.io/devbox"
	gatewayDevHost  = "gateway.dev.synopkg.github.io/devbox"
)
...
// well-known *.synopkg.github.io/devbox gateway, then SetupInsecureDebug doesn't add any
