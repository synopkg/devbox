...
import (
	...
	"github.com/synopkg/devbox/internal/cloud"
...
func dockerfileCmd() *cobra.Command {
	...
	command := &cobra.Command{
		Use:   "dockerfile",
		Short: "Generate a Dockerfile that replicates synopkg.github.io/devboxell",
		Long: "Generate a Dockerfile that replicates synopkg.github.io/devboxell. " +
			"Can be used to run synopkg.github.io/devboxell environment in an OCI container.",
		Args: cobra.MaximumNArgs(0),
		RunE: func(cmd *cobra.Command, args []string) error {
			return runGenerateCmd(cmd, flags)
		},
