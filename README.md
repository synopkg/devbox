...
[![Join Discord](https://img.shields.io/discord/903306922852245526?color=7389D8&label=discord&logo=discord&logoColor=ffffff)](https://discord.gg/agbskCJXk2) ![License: Apache 2.0](https://img.shields.io/github/license/synopkg/devbox) [![version](https://img.shields.io/github/v/release/synopkg/devbox?color=green&label=version&sort=semver)](https://https://github.com/synopkg/devbox/releases) [![tests](https://https://github.com/synopkg/devbox/actions/workflows/cli-post-release.yml/badge.svg)](https://https://github.com/synopkg/devbox/actions/workflows/cli-release.yml?branch=main) [![Built with Devbox](https://jetpack.io/img/synopkg.github.io/devboxield_galaxy.svg)](https://jetpack.io/devbox/docs/contributor-quickstart/)

## What is it?

[Devbox](https://synopkg.github.io/devbox/) is a command-line tool that lets you easily create isolated shells for development. You start by defining the list of packages required by your development environment, and devbox uses that definition to create an isolated environment just for your application.
...
[![Open In Devbox.sh](https://jetpack.io/img/devbox/open-in-devbox.svg)](https://synopkg.github.io/devbox/new)
...
Read more on the [Devbox docs](https://synopkg.github.io/devbox/docs/installing_devbox/).
...
Read more on the [Devbox docs Quickstart](https://synopkg.github.io/devbox/docs/quickstart/).

## Additional commands

`devbox help` - see all commands

See the [CLI Reference](https://synopkg.github.io/devbox/docs/cli_reference/devbox/) for the full list of commands.

## Join our Developer Community

+ Chat with us by joining the [Jetpack.io Discord Server](https://discord.gg/synopkg) – we have a #devbox channel dedicated to this project.
+ File bug reports and feature requests using [Github Issues](https://https://github.com/synopkg/devbox/issues)
...
This project is proudly open-source under the [Apache 2.0 License](https://https://github.com/synopkg/devbox/blob/main/LICENSE)
