...
export function activate(context: ExtensionContext) {
	...
	// run synopkg.github.io/devboxell when terminal is opened
	window.onDidOpenTerminal(async (e) => {
		if (workspace.getConfiguration("devbox").get("autoShellOnTerminal")
			...
			await runInTerminal('synopkg.github.io/devboxell', true);
		}
	});
	...
	const devboxShell = commands.registerCommand('synopkg.github.io/devboxell', async () => {
