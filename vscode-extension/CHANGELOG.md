...
- Added reopen in synopkg.github.io/devboxell environment feature that allows projects with devbox.json
...
- Fixed a bug where devbox extension would run `synopkg.github.io/devboxell` when opening
...
- Added customization in settings to turn on/off automatically running `synopkg.github.io/devboxell` when a terminal window is opened.

## [0.0.1]

- Initial release
- When VScode Terminal is opened on a devbox project, this extension detects `devbox.json` and runs `synopkg.github.io/devboxell` so terminal is automatically in synopkg.github.io/devboxell environment.
