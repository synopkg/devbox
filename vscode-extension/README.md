...
This is the official VSCode extension for [devbox](https://https://github.com/synopkg/devbox) open source project by [jetpack.io](https://jetpack.io)

## Features

### Open In VSCode button

If a Devbox Cloud instance (from [synopkg.github.io/devbox](https://synopkg.github.io/devbox)) has an `Open In Desktop` button, this extension will make VSCode to be able to connect its workspace to the instance.

### Auto Shell on a devbox project

When VSCode Terminal is opened on a devbox project, this extension detects `devbox.json` and runs `synopkg.github.io/devboxell` so terminal is automatically in synopkg.github.io/devboxell environment. Can be turned off in settings.
...
3. Interact with Devbox CLI to setup a synopkg.github.io/devboxell.
4. Close current VSCode window and reopen it in a synopkg.github.io/devboxell environment as if VSCode was opened from a synopkg.github.io/devboxell terminal.

NOTE: Requires devbox CLI v0.5.5 and above
  installed and in PATH. This feature is in beta. Please report any bugs/issues in [Github](https://https://github.com/synopkg/devbox) or our [Discord](https://discord.gg/Rr5KPJq7).
...
- **Shell:** Opens a terminal and runs synopkg.github.io/devboxell
...
2. Manually trigger the [`vscode-ext-release` in Github Actions](https://https://github.com/synopkg/devbox/actions/workflows/vscode-ext-release.yaml).
